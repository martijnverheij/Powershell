...
$O365CustomerName      = "mvgm"          #This should be the name of your tenant (example, ogd as in ogd.onmicrosoft.com) 
...
$desiredMappings =  @(
    @{"displayName"="Onedrive for Business";"targetLocationType"="driveletter";"targetLocationPath"="H:";"sourceLocationPath"="autodetect";"mapOnlyForSpecificGroup"=""}
)
