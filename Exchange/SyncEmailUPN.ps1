...
$searchbase = "OU=USERS BO,DC=CONTOSO,DC=COM" 
...
$CollObjects=Get-ADObject -LDAPFilter "(&(legacyExchangeDN=*)(objectClass=user))" -Searchbase $searchbase -Properties ProxyAddresses,distinguishedName,userPrincipalName
